var options1 = {
    ...
    fill: {
        opacity: [1],
        type: ["gradient"],
        gradient: { type: "vertical", inverseColors: false, opacityFrom: 0.5, opacityTo: 0, stops: [0, 100] }
    }
};
...
options1 = {
    chart: { type: "area", height: 50, sparkline: { enabled: true } },
    series: [{ data: [87, 54, 4, 76, 31, 95, 70, 92, 53, 9, 6] }],
    stroke: { width: 2, curve: "smooth" },
    markers: { size: 0 },
    colors: ["#7e67fe"],
    tooltip: {
...
options1 = {
    chart: { type: "area", height: 50, sparkline: { enabled: true } },
    series: [{ data: [41, 42, 35, 42, 6, 12, 13, 22, 42, 94, 95] }],
    stroke: { width: 2, curve: "smooth" },
    markers: { size: 0 },
    colors: ["#7e67fe"],
    tooltip: {
...
options1 = {
    chart: { type: "area", height: 50, sparkline: { enabled: true } },
    series: [{ data: [8, 41, 40, 48, 77, 35, 0, 77, 63, 100, 71] }],
    stroke: { width: 2, curve: "smooth" },
    markers: { size: 0 },
    colors: ["#7e67fe"],
    tooltip: {
...
new ApexCharts(document.querySelector("#conversions"), options).render();
...
options = {
    series: [
        ...
        { name: "Revenue", type: "area", data: [12, 16, 11, 22, 28, 25, 15, 29, 35, 45, 42, 48] }
    ],
    ...
    grid: {
        ...
        padding: { top: 0, right: -2, bottom: 10, left: 10 }
    },
    legend: {
        show: true,
    ...
    tooltip: {
        shared: true,
        y: [
            { formatter: function (e) { return e !== undefined ? e.toFixed(1) + "k" : e; } },
            { formatter: function (e) { return e !== undefined ? e.toFixed(1) + "k" : e; } }
        ]
    }
};
new ApexCharts(document.querySelector("#dash-performance-chart"), options).render();
