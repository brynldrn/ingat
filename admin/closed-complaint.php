            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="complaintsTable" class="table table-hover mb-0 table-centered">
                        ...
                        <tbody>
                        <?php 
$query = mysqli_query($conn, "SELECT c.complaint_number, u.firstname, u.middlename, u.lastname, c.registered_at, c.status FROM tblcomplaints c JOIN users u ON u.id = c.userId WHERE c.status = 'Solved' LIMIT 25;");
