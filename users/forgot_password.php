...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        // Generate a unique token (100 characters long)
        ...
        if ($updateQuery) {
            ...
            try {
                ...
                // Attach the logo image for embedding in the email
      ...
      <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
          ...
          <p class="text-center mt-4 text-white text-opacity-50">
            <a href="dashboard.php" class="text-decoration-none text-white fw-bold">Back to Sign In</a>
          </p>
        </div>
      </div>
    </div>
